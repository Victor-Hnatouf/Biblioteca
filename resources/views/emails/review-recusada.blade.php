...
<div style="font-family: Arial, sans-serif; line-height: 1.5; color: #111;">
    <h2 style="margin: 0 0 12px 0;">Review Recusada</h2>

    <p style="margin: 0 0 16px 0;">
        A tua review foi recusada e não será visível para outros cidadãos.
    </p>
    ...
    @if($review->justificacao_recusa)
        <div style="margin-top: 16px; border: 1px solid #fca5a5; padding: 12px; border-radius: 8px; background-color: #fef2f2;">
            <p style="margin: 0 0 6px 0;"><strong>Justificação da recusa:</strong></p>
            <p style="margin: 0;">{{ $review->justificacao_recusa }}</p>
        </div>
    @endif
